...
class ImageController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/{fid}",  name="admin_image_delete", methods={"DELETE"})
     */
    public function delete(Request $request, $fid, Image $image): Response
    {
        ...
        return $this->redirectToRoute('admin_image_new',['id'=>$fid]);
    }
}
